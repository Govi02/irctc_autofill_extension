                ...
                if (packet.status === 'resolve') {
                    ...
                    this._resolve.forEach(function (fn) {
                        ...
                        if (ret && typeof ret.then == 'function') {
                            Promise.resolve(console.warn('TesseractJob instances do not chain like ES6 Promises. To convert it into a real promise, use Promise.resolve.'));
                        }
                    });
                    this._resolve = data;
                    ...
                    Promise.resolve(console.warn('Message type unknown', packet.status));
                }
        ...
        _createClass(TesseractWorker, [{
            ...
            value: function _recv(packet) {
                ...
                if (this._currentJob.id === packet.jobId) {
                    ...
                    Promise.resolve( console.warn('Job ID ' + packet.jobId + ' not known.'));
                }
            }
        }]);
